 ...
 * @version $Id: main_template_vars.php for pdf attachment 2019-11-09 14:47:36Z webchills $
 */
/*
 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $sql = "select p.products_id, pd.products_name, pd.pdf_attachment_name,
                  pd.products_description, p.products_model,
                  p.products_quantity, p.products_image, p.products_pdf_attachment, 
...
// if review must be approved or disabled do not show review
  ...
  $pdf_attachment_name = $product_info->fields['pdf_attachment_name'];
  ...
  $products_pdf_attachment = $product_info->fields['products_pdf_attachment'];
...
// build show flags from product type layout settings
  ...
  $flag_show_product_info_pdf_attachment = zen_get_show_product_switch($_GET['products_id'], 'pdf_attachment');
