 ...
 * @version $Id: copy_product_confirm.php for pdf attachment 2020-02-06 17:36:16Z webchills $
 */
...
if (isset($_POST['products_id']) && isset($_POST['categories_id'])) {
    ...
    $db->Execute("INSERT INTO " . TABLE_PRODUCTS . " (products_type, products_quantity, products_model, products_image, products_pdf_attachment, 
                  ...
                  VALUES ('" . zen_db_input($product->fields['products_type']) . "',
                          ...
                          '" . zen_db_input($product->fields['products_pdf_attachment']) . "',
                          '" . $products_price . "',
    ...
    $descriptions = $db->Execute("SELECT language_id, products_name, pdf_attachment_name, products_merkmale, products_description, products_url
