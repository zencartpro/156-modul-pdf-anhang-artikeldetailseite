 ...
 * @version $Id: product.php for pdf attachment 2020-02-06 17:49:16Z webchills $
 */
...
//pdf attachment
define('TEXT_PDF_ATTACHMENT_NAME', 'Name for pdf attachment:');
define('TEXT_PRODUCTS_PDF_ATTACHMENT', 'File for pdf attachment:');
define('TEXT_PDF_ATTACHMENT_NONEXISTENT', 'Currently no pdf added');
define('TEXT_PRODUCTS_PDF_ATTACHMENT', 'pdf attachment for product:');
define('TEXT_PRODUCTS_PDF_ATTACHMENT_DIR', 'Upload to directory:');
define('TEXT_PDF_ATTACHMENT_CURRENT', 'pdf File: ');
define('TEXT_PDF_ATTACHMENT_DELETE', 'Delete pdf?<br/>Removes the pdf from product, pdf will NOT be deleted from server:');
define('TEXT_PDF_ATTACHMENT_OVERWRITE', 'Overwrite existing pdf on server? Use "No" if you enter the filename manually');
define('TEXT_PRODUCTS_PDF_ATTACHMENT_MANUAL', 'Or choose an existing pdf from server, filename:');