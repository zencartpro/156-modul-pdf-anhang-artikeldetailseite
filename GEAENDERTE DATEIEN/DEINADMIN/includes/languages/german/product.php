...
//pdf attachment
define('TEXT_PDF_ATTACHMENT_NAME', 'Name für pdf Anhang:');
define('TEXT_PRODUCTS_PDF_ATTACHMENT', 'Datei für pdf Anhang:');
define('TEXT_PDF_ATTACHMENT_NONEXISTENT', 'Derzeit kein pdf zugeordnet');
define('TEXT_PRODUCTS_PDF_ATTACHMENT', 'pdf Anhang zum Artikel:');
define('TEXT_PRODUCTS_PDF_ATTACHMENT_DIR', 'Uploadverzeichnis:');
define('TEXT_PDF_ATTACHMENT_CURRENT', 'pdf Datei: ');
define('TEXT_PDF_ATTACHMENT_DELETE', 'pdf löschen?<br/>pdf wird dabei NICHT vom Server gelöscht:');
define('TEXT_PDF_ATTACHMENT_OVERWRITE', 'Bestehendes pdf überschreiben? Verwenden Sie "Nein" bei manuell eingegebenem Namen');
define('TEXT_PRODUCTS_PDF_ATTACHMENT_MANUAL', 'Oder wählen Sie ein bestehendes pdf vom Server, Dateiname:');